" Vim color file - bwebs
" Generated by http://bytefluent.com/vivify 2017-08-17
set background=dark
if version > 580
	hi clear
	if exists("syntax_on")
...
hi   FoldColumn                 guifg=#a0a8b0   guibg=#384048   guisp=#384048   gui=NONE   ctermfg=103    ctermbg=235    cterm=NONE
...
hi   String                     guifg=#ab9a6a   guibg=NONE      guisp=NONE      gui=NONE   ctermfg=137    ctermbg=NONE   cterm=NONE
...
hi   TabLineSel                 guifg=#9e9e9e   guibg=#303030   guisp=#f0f0f0   gui=NONE   ctermfg=245    ctermbg=236    cterm=NONE
...
hi   Search                     guifg=NONE      guibg=#505050   guisp=NONE      gui=bold   ctermfg=NONE   ctermbg=NONE   cterm=bold
